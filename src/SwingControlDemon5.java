...
public class SwingControlDemon5 {
    private JFrame mainFrame;
    private JLabel headerLabel;
    private JLabel statusLabel;
    private JPanel controlPanel;

    public SwingControlDemon5(){
        prepareGUI();
    }
    public static void main(String[] args){
        SwingControlDemon5  SwingControlDemon5 = new SwingControlDemon5();
        SwingControlDemon5.showRadioButtonDemo();
    }
